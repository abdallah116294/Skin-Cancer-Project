...
class PreventionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InfoWidget(title: "Skin Cancer Prevention",
        imagePath: "assets/image/cancer_prevention.png",
        supTitle: "Skin cancer prevention requires a comprehensive approach to protecting yourself against harmful ultraviolet (UV) radiation. +" +
