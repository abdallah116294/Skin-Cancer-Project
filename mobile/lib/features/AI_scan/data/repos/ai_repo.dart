...
abstract class AIRepo {
  ...
  Future<Either<String, UploadSuccessModel>> uploadAiDetection(
      String userId, String result, File image);
  Future<Either<String, List<AiHistoryModel>>> getAiDetection(String userId);
  Future<List<Disease>> getDiseaseInfo();
  Future<Either<String, String>> addDiagnosis(int id, String diagonosis,String token);
}
