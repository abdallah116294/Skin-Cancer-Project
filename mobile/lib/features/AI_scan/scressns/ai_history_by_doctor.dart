...
class AiHistoryByDoctor extends StatefulWidget {
  final String userId;
  const AiHistoryByDoctor({super.key, required this.userId});

  @override
  State<AiHistoryByDoctor> createState() => _AiHistoryByDoctorState();
}

class _AiHistoryByDoctorState extends State<AiHistoryByDoctor> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocProvider(
        create: (context) =>
            di.sl<AiPeredictionCubit>()..getAiHistory(widget.userId),
