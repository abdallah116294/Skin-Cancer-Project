    ...
    return BlocProvider(
        ...
        child: BlocConsumer<ClinicCubit, ClinicState>(
          listener: (context, state) {
            if (state is DeleteClinicIsSuccesse) {
              CacheHelper.removeData(key: 'clinicName');
              DailogAlertFun.showMyDialog(
                  daliogContent: state.addClinicSuccessModel.message.toString(),
                  actionName: 'Go Home',
                  context: context,
                  onTap: () {
                          ...
                          IconButton(
                            onPressed: () {
                              context.read<ClinicCubit>().deleteClinic(
                                  id: state.clinicModel.id, token: token);
                            },
                            icon: Icon(
                              Icons.delete,
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                DocClinicWidget(
                                  ...
                                  title: "Address",
                                  subtitle:
                                      state.clinicModel.address.toString(),
                                ),
                                verticalSpacing(20),
                                DocClinicWidget(
