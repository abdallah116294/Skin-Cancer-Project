...
class PaymentCubit extends Cubit<PaymentInitialStates> {
  ...
  Future getOrderRegistrationId({
    ...
    await PaymentHelper.postData(url: StringManager.getOrderId, data: {
  ...
  Future<void> getPaymentRequest({
    ...
    await PaymentHelper.postData(url: StringManager.paymentKeyRequeset, data: {
      "auth_token": StringManager.paymentFirstToken,
      "amount_cents": price,
      "expiration": 3600,
  ...
  Future<void> getRefCode() async {
    ...
    PaymentHelper.postData(url: StringManager.getRefCode, data: {
