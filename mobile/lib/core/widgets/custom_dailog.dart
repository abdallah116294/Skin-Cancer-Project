...
class DailogAlertFun{
  ...
  static Future<void> showRationgDialog({required  double initialRating ,required   Function(double) onRatingChanged ,required  String  actionName,required BuildContext context,required VoidCallback onTap}) async {
  return showDialog<void>(
    context: context,
    barrierDismissible: false, // user must tap button!
    builder: (BuildContext context) {
            ...
            children: <Widget>[
              ...
              children: [
                  CircleAvatar(
                   ...
                   SizedBox(height: 16.h,),
                 RatingStarsWidget(initialRating:initialRating/2 ,onRatingChanged:onRatingChanged ,),
                 SizedBox(height: 30.h,),
                 CustomButton(
                   buttonName: actionName,buttoncolor: AppColor.primaryColor,height: 52.h,width: 166,white: false,onTap:onTap,textColor: Colors.white,)
